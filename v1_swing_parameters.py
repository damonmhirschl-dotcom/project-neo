...
STRATEGY_V1_TREND = 'v1_trend'
STRATEGY_NAMES    = (STRATEGY_V1_SWING, STRATEGY_V1_TREND, STRATEGY_LEGACY)
...
ATR_TARGET_1_MULTIPLIER  = 4  # T1 at 4× daily ATR (2× risk distance — research standard)
